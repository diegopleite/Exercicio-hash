    ...
    public static void main(String[] args) {
        ...
        if (a0.equals("1")) {
            ...
            for (int j = 1; j < 11; j++) {
                ...
                if (ListaTexto.procurasetem(a1, j) == true) {
        ...
        if (a0.equals("2")) {
            ...
            if (a2.equals("2")) {
                ...
                a4 = a4.toLowerCase();
                for (int j = 1; j < 11; j++) {
                    if (ListaTexto.procurasetem(a3, j) == true && ListaTexto.procurasetem(a4, j) == true) {
            ...
            if (a2.equals("3")) {
                ...
                for (int j = 1; j < 11; j++) {
                    if (ListaTexto.procurasetem(a3, j) == true && ListaTexto.procurasetem(a4, j) == true
                            && ListaTexto.procurasetem(a5, j) == true) {
        ...
        if (a0.equals("3")) {
            ...
            for (int i = 0; i < ListaTexto.frequencia(a6).size(); i++) {
                System.out.println("A palavra " + "'" + ListaTexto.frequencia(a6).get(i) + "'" + " tem frequencia "
                        + ListaTexto.nfrequencia().get(i));
            }
